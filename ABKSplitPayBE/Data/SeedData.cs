        ...
        public static async Task InitializeAsync(IServiceProvider serviceProvider)
        {
            ...
            if (adminUser == null)
            {
                adminUser = new ApplicationUser
                {
                    ...
                    Email = adminEmail,
                    FullName = "Admin User",
                    ProfilePictureUrl = "https://images.unsplash.com/photo-1511367461989-f85a21fda167?q=80&w=2070&auto=format&fit=crop",
                    EmailConfirmed = true,
            ...
            if (testUser == null)
            {
                testUser = new ApplicationUser
                {
                    ...
                    Email = testEmail,
                    FullName = "Test User",
                    ProfilePictureUrl = "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=2070&auto=format&fit=crop", 
                    EmailConfirmed = true,
